...
const UncleChatbot: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (selectedFile) {
        fullQuery = `If a File Title and Specific File is specified, you don't need to remind the user to upload any file. File Title: ${selectedFile.label} + Specific File: ${selectedFile.value} + 
         My specific question is: ${question} Go to the link that is specified in the file value, parse it then Print out the data in the file then using that data answer the question, ${question}`;
         
        //  Read this file and tell me about it in detail, including its columns, the types of data it contains, any numerical data, and any other relevant information like percentages, statistics, and its importance.
      } else {
